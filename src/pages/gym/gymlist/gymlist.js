              ...
              gym1.slice(0, 3).map((el)=>{
                  return(
                      ...
                      <div class="card p-3" style={{height:"220px"}}>
                            ...
                            <span class="ratings">
                              {[1, 2, 3, 4, 5].map((value) => (
                                <span
                                  ...
                                  style={{
                                    cursor: "pointer",
                                    color: value <= el?.averageRating ? "gold" : "grey",
                                  }}
                                >
                                  &#9733;
                                </span>
                        ...
                        <p>
                          {el.address.address.substring(0, 80)}...
                        </p>
                        {/* <div class="text-primary nonew" onClick={() => {
                      navige(el);
                    }}> */}
                    <Link to={`/aboutgym/${el._id}`} class="text-primary nonew" style={{textDecoration:"none"}}> View  <FontAwesomeIcon icon={faChevronRight} /></Link>
